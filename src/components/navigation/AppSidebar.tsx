...
export function AppSidebar({ isOpen, onClose }: AppSidebarProps) {
    ...
    return (
        <View className="absolute inset-0 z-50 bg-black/40" style={{ elevation: 50 }}>
            <View
                        ...
                        {menu.map((item) => {
                            ...
                            return (
                                <Pressable
                                    ...
                                    className={`rounded-xl px-4 py-3 ${isActive ? "bg-white" : "bg-transparent active:bg-accent"
                                        }`}
                                >
                                    <Text
                                        className={`text-base font-semibold ${isActive ? "text-primary" : "text-white"
                                            }`}
                                    >
                                        {item.label}
                                    </Text>
